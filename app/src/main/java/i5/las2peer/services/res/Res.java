...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "295", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-295/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_UNAUTHORIZED, message = "res")
  })
  ...
  public Response gettest() {
    ...
    if(res_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_UNAUTHORIZED).entity(res.toJSONString()).build();
    }
    return null;
  }
